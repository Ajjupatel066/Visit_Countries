...
class VisitCountries extends Component {
  state = {
    listOfCountries: initialCountriesList,
  }
      ...
      <div className="app-container">
        ...
        <ul className="countries-container">
          {listOfCountries.map(eachCountry => (
            <CountryItem
              ...
              key={eachCountry.id}
              clickVisitedButton={this.clickVisitedButton}
            />
          ))}
        </ul>
        ...
        <ul className="visited-countries-list">
          {updatedList.length === 0 ? (
            <p className="no-visited-country">No Countries Visited Yet</p>
          ) : (
